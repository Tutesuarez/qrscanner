...
//   const handleAddCode = () => {
//     if (newCode.trim()) {
//       axios.post('http://localhost:3000/api/qr/add-code', { code: newCode })
//         .then(response => {
...
//           alert('Hubo un error al agregar el código.');
//         });
//     }
//   };
...
//           />
//         </Form.Group>
//         <Button variant="primary" onClick={handleAddCode}>Agregar Código</Button>
//       </Form>
//     </div>
//   );
// };
